...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    SPFCoreDataService *storageService = [SPFCoreDataService new];
    SPFViewController *fc = [[SPFViewController alloc]initWithStorageService:storageService];
    ...
    SecondViewController *sc = [[SecondViewController alloc] initWithStorageService:storageService];
